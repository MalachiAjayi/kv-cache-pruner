...
if __name__ == "__main__":
    ...
    model, tokenizer = load_model_and_tokenizer(
        model_name_or_path=model_name, precision="bf16"
    )
    model.eval()
    ...
    print("KV Cache Pruner enabled")

    for method in ["full", "h2o", "kvcV", "kvcK", "kvcVK"]:
        past_key_values = load_kv_cache(
            method=method, num_recent=16, num_heavy=112, decode_evict=True
        )
